...
class Drivetrain:
    ...
    left_motor_master = WPI_TalonSRX #talon
    left_motor_slave = WPI_TalonSRX #talon
    left_motor_slave2 = WPI_VictorSPX #victor
    right_motor_master = WPI_TalonSRX #talon
    right_motor_slave = WPI_TalonSRX #talon
    right_motor_slave2 = WPI_VictorSPX #victor
